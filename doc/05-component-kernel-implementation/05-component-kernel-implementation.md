...
- **Due Date**: 04/09/2025 @ 12:40 PM EST
...
I chose to represent my FPLDataTracker component using a Map<String, Map<String, String>>, where each key is a player's name and each value is a map of that player's stats (for example: "goals" -> "12"). This makes it easy to add, remove, or update a player's stats efficiently and keeps the data organized by player.

So, I have the following:

Convention: Player names and stat names are unique.

Correspondence: Each entry in the outer map represents a player in the tracker, and the associated inner map represents that player’s statistics.
